	...
	switch (request.command){
		...
		case "getEvaluacionProfesores":
			...
			if ( (!!!localStorage.calificacion)){
				localStorage.calificacion = "null";
				localStorage.profesores = "[]";
			}
			// console.log('localStorage.calificacion : ', localStorage.calificacion);
			// console.log('localStorage.profesores : ', localStorage.profesores);
			callback({
